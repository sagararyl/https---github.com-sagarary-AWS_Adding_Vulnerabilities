    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="list-group">
                <a href="index.php#men" class="list-group-item">Men</a>
                <a href="index.php#women" class="list-group-item">Women</a>
                <a href="index.php#kids" class="list-group-item">Kids</a>
            </div>
        </div>
